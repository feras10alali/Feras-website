...
declare module '$env/static/private' {
	...
	export const AUTH_FIREBASE_PROJECT_ID: string;
	export const AUTH_FIREBASE_CLIENT_EMAIL: string;
	export const AUTH_FIREBASE_PRIVATE_KEY: string;
